...
3.  Upload WebSphere Application Server bulk data to TA Local.
    ...
    a. Upload the **bulk_data_3.zip** using the following command in a terminal window on the **Workstation** VM:
        ...
        curl -v -k -X POST "http://server0.gym.lan:2220/lands_advisor/advisor/v2/collectionArchives/bulkImport" -H "accept: */*" -H "archiveName: bulk_data_3.zip" -H "Content-Type: application/octet-stream" --data-binary "@/home/techzone/Student/appmod-pot-labfiles/labs/TransformationAdvisor/bulk_data_3.zip" 
